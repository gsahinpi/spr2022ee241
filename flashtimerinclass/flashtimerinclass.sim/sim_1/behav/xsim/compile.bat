...
REM
REM Generated by Vivado on Sat May 14 15:50:51 +0300 2022
...
echo "xvlog --incr --relax -prj TestFlash_vlog.prj"
call xvlog  --incr --relax -prj TestFlash_vlog.prj -log xvlog.log
