...
REM
REM Generated by Vivado on Fri May 20 14:57:44 +0300 2022
...
echo "xvlog --incr --relax -prj testcontroller_vlog.prj"
call xvlog  --incr --relax -prj testcontroller_vlog.prj -log xvlog.log
