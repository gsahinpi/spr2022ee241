...
REM
REM Generated by Vivado on Thu May 19 16:08:28 +0300 2022
...
echo "xvlog --incr --relax -prj Datapathtest_vlog.prj"
call xvlog  --incr --relax -prj Datapathtest_vlog.prj -log xvlog.log
