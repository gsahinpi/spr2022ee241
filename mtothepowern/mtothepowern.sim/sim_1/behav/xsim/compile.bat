...
REM
REM Generated by Vivado on Tue May 31 15:48:52 +0300 2022
...
echo "xvlog --incr --relax -prj controller2test_vlog.prj"
call xvlog  --incr --relax -prj controller2test_vlog.prj -log xvlog.log
