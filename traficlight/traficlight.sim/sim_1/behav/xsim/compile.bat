...
REM
REM Generated by Vivado on Sat May 14 15:02:04 +0300 2022
...
echo "xvlog --incr --relax -prj traffictest_vlog.prj"
call xvlog  --incr --relax -prj traffictest_vlog.prj -log xvlog.log
