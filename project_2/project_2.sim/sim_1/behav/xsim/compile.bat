...
REM
REM Generated by Vivado on Tue Apr 19 13:53:30 +0300 2022
...
echo "xvlog --incr --relax -prj full4tb_vlog.prj"
call xvlog  --incr --relax -prj full4tb_vlog.prj -log xvlog.log
