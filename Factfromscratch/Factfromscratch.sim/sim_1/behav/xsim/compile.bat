...
REM
REM Generated by Vivado on Fri May 20 22:49:00 +0300 2022
...
echo "xvlog --incr --relax -prj controltest_vlog.prj"
call xvlog  --incr --relax -prj controltest_vlog.prj -log xvlog.log
